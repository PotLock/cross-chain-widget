          ...
          >
            <div
              style={{
                ...
                zIndex: 0,
                opacity: 0.5,
                ...(isMobile && { top: 330, left: 140, width: "100%", height: "100%", pointerEvents: "none", overflow: "hidden" }),
              }}
            >
              <svg
                width="449"
                ...
                >
                  ...
                  <div
                    style={{
                      ...
                      ...(isCopyButtonHovered && { background: "#f2f2f2", transform: "translateY(-2px)" }),
                    }}
...
//           }}
//         >
//           <h2 style={inlineStyles.modalTitle}>Donation Confirmed</h2>
//           <button
//             style={{
...
//           <div
//             style={{
//               ...inlineStyles.confirmationContainer,
//               ...(isMobile ? inlineStyles.confirmationContainerMobile : {}),
//             }}
//           >
//             <div
//               style={{
//                 ...inlineStyles.confettiBg,
//                 ...(isMobile ? inlineStyles.confettiBgMobile : {}),
//               }}
//             >
//               <svg
//                 width="449"
...
//             <div
//               style={{
//                 ...inlineStyles.confirmationContent,
//               }}
//             >
//               <div
//                 style={{
//                   ...inlineStyles.successIcon,
//                   ...(isMobile ? inlineStyles.successIconMobile : {}),
//                 }}
//               >
//                 <svg
//                   width={isMobile ? 80 : 100}
...
//               <h2
//                 style={{
//                   ...inlineStyles.successTitle,
//                   ...(isMobile ? inlineStyles.successTitleMobile : {}),
//                 }}
//                 aria-live="polite"
//               >
//                 Donation Successful!
//               </h2>
//               <p style={inlineStyles.amountLine}>
//                 <span style={inlineStyles.solAmount}>
//                   {amount_digit} {amount_symbol}
//                 </span>{" "}
//                 ~<span style={inlineStyles.usdAmount}>${usdAmount}</span>
//               </p>
//               <p style={inlineStyles.donatedTo}>
//                 has been donated to{" "}
//                 <strong style={inlineStyles.donatedToStrong}>
//                   {campaignName}
//                 </strong>
//               </p>
//               <div
//                 style={{
//                   ...inlineStyles.feeBreakdown,
//                   ...(isMobile ? inlineStyles.feeBreakdownMobile : {}),
//                 }}
//               >
//                 <h4 style={inlineStyles.feeBreakdownTitle}>Fee Breakdown</h4>
...
//                   </div>
//                 )}
//                 <hr style={inlineStyles.feeBreakdownHr} />
//                 <div style={inlineStyles.feeBreakdownTotal}>
//                   <strong>Total (incl. fees):</strong>
//                   <strong>{(donationAmount + totalFee).toFixed(4)} NEAR</strong>
//                 </div>
//               </div>
//               <div style={inlineStyles.txHash}>
//                 <span>Txn Hash:</span>
//                 <div style={inlineStyles.txHashContent}>
//                   <span style={inlineStyles.shortenedHash}>
//                     {shortenHash(txHash)}
//                   </span>
//                   <div
//                     style={{
