...
const Modal3: React.FC<Modal3Props> = ({
  ...
  const [isSentFundsButtonHovered, setIsSentFundsButtonHovered] = useState(false);
        ...
        <div>
          ...
          <div
            style={{
              ...
              borderRadius: "10px",
              marginLeft: "60px",
              ...(isMobile && { width: "180px", height: "180px", padding: "15px", marginLeft: "0", margin: "0 auto" }),
            }}
          >
            <QRCodeSVG
          ...
          <div
            style={{
              ...
              alignItems: "center",
              marginTop: "40px",
              ...(isMobile && { width: "92%", padding: "10px", marginTop: "30px" }),
            }}
          >
            <div
              style={{
        ...
        >
          <button
            style={{
              ...
              ...(isBackButtonHovered && { background: "#d1d8e0", transform: "translateY(-2px)", boxShadow: "0 6px 15px rgba(0, 0, 0, 0.15)" }),
          ...
          <button
            style={{
              ...
              fontWeight: 700,
              transition: "background 0.3s, transform 0.2s, box-shadow 0.3s",
              ...(isSentFundsButtonHovered && { background: "#000000", transform: "translateY(-2px)", boxShadow: "0 8px 10px rgba(30, 58, 138, 0.4)" }),
