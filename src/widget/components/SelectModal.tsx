      ...
      >
              ...
              displayedItems.map((item) => (
                <div
                  ...
                  style={{
                    ...
                    marginBottom: "15px",
                    ...(selectedCampaign === item.id && { backgroundColor: "#F5F5F5" }),
        ...
        <div
          style={{
            ...
            ...(isMobile && { flexDirection: "column" as const, gap: "10px", marginTop: "20px", paddingTop: "15px" }),
          }}
        >
          <button
            style={{
              ...
              ...(!selectedCampaign && { backgroundColor: "#00000044", cursor: "not-allowed" }),
              ...(isMobile && { width: "100%", padding: "10px", fontSize: "15px" }),
            }}
